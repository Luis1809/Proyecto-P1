...
public class SolicitudesObrero extends Solicitudes {
	...
	public SolicitudesObrero(String sexo, String estadoCivil, String cuidad, String pais, String salirioSolicitado,
			boolean dispMudarse, boolean dispViajar, String tipoJornada, ArrayList<String> idioma, String areaInteres,
			boolean licencia, String area, String anosExp, int plaza, ArrayList<String> listaHabilidades) {
